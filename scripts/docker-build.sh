...
echo ""
echo "Run locally:"
echo "  docker compose --env-file .env.compose.development.local up"
echo ""
echo "Run production with PostgreSQL:"
echo "  docker compose --env-file .env.compose.production.local -f docker-compose.yml -f docker-compose.prod.yml up -d"
echo ""
